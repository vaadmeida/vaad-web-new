    ...
    <div className="bg-transparent border border-[#EDEDF2] rounded-2xl p-8">
      ...
      <div className="space-y-6">
        ...
        <Select
          ...
          options={[{ label: "Live Mentions / Shoutouts", value: "" }]}
        />
        <div className="flex gap-6 w-full">
          <div className="flex-1">
            <Select
              label="Campaign Duration"
              options={[{ label: "2 Weeks", value: "" }]}
            />
          </div>

          <div className="flex-1">
            <Select
              label="Advertising Budget Range"
              options={[{ label: "₦500,000 – ₦1,000,000", value: "" }]}
            />
          </div>
        </div>
      </div>
          ...
          <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 pt-16">
            <div className="max-w-3xl mx-auto text-center flex flex-col items-center">
              ...
              <p className="text-lg md:text-[15.19px] font-semibold text-white mb-8 max-w-100 text-center">
                Get Your Billboard Ad Delivered In 24hrs and Get Discounted Billboard Offer.
              </p>
              <div className="flex items-center justify-center gap-2 text-sm text-white/80">
                ...
                <span>&gt;</span>
                <span className="text-white">TV Advertising</span>
              </div>
            </div>
          </div>
        </section>
