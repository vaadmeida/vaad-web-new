...
import EmptyState from "./Home/EmptyState/EmptyState";
...
export default function SimilarMedia({
  ...
  if (loading) {
    return (
      <section className="p-18 bg-[#F9FAFB]">
  ...
  return (
    <section className="p-18 bg-[#F9FAFB]">
      <div className="mx-auto">
        ...
        {/* Billboard Count Info */}
        {billboards.length > 0 && (
          <p className="text-sm text-gray-500 mb-4">
            Showing {displayedBillboards.length} of {billboards.length} similar
            media
