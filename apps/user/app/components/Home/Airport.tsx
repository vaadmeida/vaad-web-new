...
export default function AirportSection({
  ...
  const { airportBillboards, loading, error, refetch } = useAllBillboards();

  const displayedBillboards = useMemo(
    () => airportBillboards.slice(0, limit),
    [airportBillboards, limit]
  );
  const hasMore = airportBillboards.length > 3;
      ...
      <div className="mx-auto">
        ...
        {hasMore && showViewAll && (
          <div className="mt-10 text-center md:hidden">
            ...
            >
              Explore All {airportBillboards.length} Airport Ads
