    ...
    <section className="w-full bg-white p-18">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-10">
        ...
        {showViewAll && (
          <Link
            href="/billboards"
            className="inline-flex underline underline-offset-4 items-center gap-2 text-[#0177AB] hover:text-[#0177AB] font-medium text-[17.44px] mt-4 md:mt-0 group"
          >
            <span>View All</span>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* RIGHT GRID */}
        <div className="grid grid-rows-2 gap-6 h-[546.875px]">
          {/* TOP RIGHT */}
